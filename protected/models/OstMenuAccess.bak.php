...
//        if ($ref == 'ROLE2')
//            return CHtml::checkBoxList('MenuRoleMapping[role_code][]', $selected_role_arr, $role_arr, array('separator' => '', 'template' => "<span style='margin-right:30px;'>{input}&nbsp;&nbsp;{label}</span>"));
//        else
            return CHtml::checkBoxList('OstMenuAccess[role_code][]', $selected_role_arr, $role_arr);
    }
}
