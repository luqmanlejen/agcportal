...
/**
 * This is the model class for table "ost_video_album".
 *
 * The followings are the available columns in table 'ost_video_album':
 * @property integer $id
 ...
 */
class OstVideoAlbum extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, title, descr, event_dt, parent_id, lang, created_dt, created_by, updated_dt, updated_by', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('updated_by',$this->updated_by,true);
                ...
                if (!isset($_GET['OstVideoAlbum_sort']))
	 ...
	 * @return OstVideoAlbum the static model class
	 */
    ...
    public function displaylang() {
        ...
        $model = OstVideoAlbum::model()->findAllByAttributes(array('parent_id' => $this->id));
        if (sizeof($model) > 0) {
