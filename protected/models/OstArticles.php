...
class OstArticles extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('title, created_by, updated_by, tag', 'length', 'max' => 255),
            array('inform_user, created_dt, created_by, updated_dt, updated_by, display_startdt,'
                . 'display_enddt, tag', 'safe'),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('id, menu_id, approval_sts, title, content, display_type, display_startdt, '
                . 'display_enddt, inform_user, parent_id, lang, created_dt, created_by, '
                . 'updated_dt, updated_by, view_latest, tag', 'safe', 'on' => 'search'),
        );
    }
