...
class OstMenuAccess extends CActiveRecord {
    ...
    public function displayRoleCB($menu_id, $ref) {
        ...
        $role_arr2 = OstRefList::model()->listRef3(3);
        ...
        return CHtml::checkBoxList('OstMenuAccess[role_code][]', $selected_role_arr, $role_arr) . ':-<br><div style="padding-left:20px;">' . CHtml::checkBoxList('OstMenuAccess[role_code][]', $selected_role_arr2, OstRefList::model()->listRef3(3)) . '</div>';
    }
