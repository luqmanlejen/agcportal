...
$('.search-form form').submit(function(){
	$('#lkp-hr-jawatan-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
<div class="main-content">
    <div class="main-content-inner">
        ...
        <div class="page-content">
            ...
            <div class="page-header"><h1>Manage Position</h1></div>
            <div class="row">
                <div class="col-xs-12">
                                ...
                                array('header' => 'Action', 'class' => 'CButtonColumn',
                                    ...
                                    array(
                                        'update' => array(
                                            ...
                                            'url' => 'Yii::app()->createUrl("LkpHrJawatan/update&id=$data->JTN_ID")',
                                            'imageUrl' => false,
                                        ),
                                        'delete' => array(
                                            ...
                                            'imageUrl' => false,
                                            'url' => 'Yii::app()->createUrl("LkpHrJawatan/delete&id=$data->JTN_ID")',
                                        ),
                                    ),
                                ),
                            ),
