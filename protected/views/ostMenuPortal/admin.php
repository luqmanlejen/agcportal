...
$('.search-form form').submit(function(){
	$('#ost-menu-portal-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
                    ...
                    <div class="dataTables_wrapper form-inline no-footer" id="dynamic-table_wrapper">
                        ...
                        $this->widget('zii.widgets.grid.CGridView', array(
                            ...
                            'columns' => array(
                                ...
                                array('name' => 'menu_type', 'value' => 'ucfirst($data->menu_type)', 'htmlOptions' => array('width' => '100', 'align' => 'center')),
                                ...
                                array('header' => 'Action', 'class' => 'CButtonColumn',
                                    ...
                                    array(
                                        'update' => array(
                                            ...
                                            'url' => 'Yii::app()->createUrl("ostMenuPortal/update&id=".$data->id)',
                                            'imageUrl' => false,
                                        ),
                                        'delete' => array(
                                            ...
                                            'imageUrl' => false,
                                            'url' => 'Yii::app()->createUrl("ostMenuPortal/delete&id=".$data->id)',
                                        ),
                                    ),
                                ),
                            ),
