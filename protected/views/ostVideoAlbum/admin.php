...
$('.search-form form').submit(function(){
	$('#ost-video-album-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
<div class="main-content">
    <div class="main-content-inner">
        ...
        <div class="page-content">
            ...
            <div class="page-header"><h1>Video Gallery</h1></div>
            <div class="row">
                <div class="col-xs-12">
                                ...
                                array('header' => 'Action', 'class' => 'CButtonColumn',
                                    ...
                                    array(
                                        'update' => array(
                                            ...
                                            'url' => 'Yii::app()->createUrl("ostVideoAlbum/update&id=".$data->id)',
                                            'imageUrl' => false,
                                            'visible' => '1'
                                        ),
                                        'delete' => array(
                                            ...
                                            'imageUrl' => false,
                                            'url' => 'Yii::app()->createUrl("ostVideoAlbum/delete&id=".$data->id)',
                                            'visible' => '1'
                                        ),
                                    ),
                                ),
