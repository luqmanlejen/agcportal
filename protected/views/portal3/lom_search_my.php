...
//        )));
    ...
    <div class='three_quarter push10'>
        ...
        <input value="<?php echo $reset_btn; ?>" class="button small orange" type="reset" onclick="javascript:location.href = 'index.php?r=portal3/lom_my&menu_id=b21XYmExVUhFOE4wempZdE1vNUVKdz09'">
