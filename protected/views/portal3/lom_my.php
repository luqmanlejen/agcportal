...
<?php $url = 'index.php?r=portal3/lom_my&menu_id=' . $_GET['menu_id']; ?>
            ...
            <tr>
                ...
                <th width='130'>
                    <?php 
                        if(isset($_GET['sortA'])) {
                            if($_GET['sortA'] == 'ASC'){
                                echo '<a href="index.php?r=portal3/lom_my&menu_id=VXlsMDlEclhJVXlGcUd6c0JreVhEUT09&sortA=DESC" style="color:white">'.$act.'</a>';
                            } else {
                                echo '<a href="index.php?r=portal3/lom_my&menu_id=VXlsMDlEclhJVXlGcUd6c0JreVhEUT09&sortA=ASC" style="color:white">'.$act.'</a>';
                            }
                        } else {
                            echo '<a href="index.php?r=portal3/lom_my&menu_id=VXlsMDlEclhJVXlGcUd6c0JreVhEUT09&sortA=DESC" style="color:white">'.$act.'</a>';
                        }
                        ...
                        if(isset($_GET['sort'])) {
                            if($_GET['sort'] == 'DESC'){
                                echo '<a href="index.php?r=portal3/lom_my&menu_id=VXlsMDlEclhJVXlGcUd6c0JreVhEUT09&sort=ASC" style="color:white">'.$title.'</a>';
                            } else {
                                echo '<a href="index.php?r=portal3/lom_my&menu_id=VXlsMDlEclhJVXlGcUd6c0JreVhEUT09&sort=DESC" style="color:white">'.$title.'</a>';
                            }
                        } else {
                            echo '<a href="index.php?r=portal3/lom_my&menu_id=VXlsMDlEclhJVXlGcUd6c0JreVhEUT09&sort=ASC" style="color:white">'.$title.'</a>';
                        }
