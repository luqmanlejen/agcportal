...
$('.search-form form').submit(function(){
	$('#lkp-hr-gelaran-dk-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
    ...
    <div class="main-content-inner">
        ...
        <div class="breadcrumbs" id="breadcrumbs">
            ...
            <ul class="breadcrumb">
                ...
                <li class="active">Manage Honorary Title</li>
            </ul><!-- /.breadcrumb -->
        </div>
        <!-- /section:basics/content.breadcrumbs -->
        ...
        <div class="page-content">
            ...
            <div class="page-header"><h1>Manage Honorary Title</h1></div>
            <div class="row">
                <div class="col-xs-12">
                    <div class="dataTables_wrapper form-inline no-footer" id="dynamic-table_wrapper">
                        ...
                        $this->widget('zii.widgets.grid.CGridView', array(
                            ...
                            'columns' => array(
                                ...
                                'GDK_GELARAN',
                                array('name' => 'GDK_ID_KEMASKINI', 'value' => '$data->reladmin->name'),
                                'GDK_TKH_KEMASKINI',
                                array('header' => 'Action', 'class' => 'CButtonColumn',
                                    ...
                                    array(
                                        'update' => array(
                                            ...
                                            'url' => 'Yii::app()->createUrl("lkpHrGelaranDk/update&id=$data->GDK_ID")',
                                            'imageUrl' => false,
                                        ),
                                        'delete' => array(
                                            ...
                                            'imageUrl' => false,
                                            'url' => 'Yii::app()->createUrl("lkpHrGelaranDk/delete&id=$data->GDK_ID")',
                                        ),
                                    ),
                                ),
                            ),
