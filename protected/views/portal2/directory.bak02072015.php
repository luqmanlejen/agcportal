    ...
    if ($search == 1) {
        ...
        $query1 = " SELECT
                    ...
                    ORDER BY
                        ...
                        HR_STAF_PERIBADI.STF_GRED_ID DESC, LKP_GRED.GRED_SUSUNAN ASC, LENGTH(HR_STAF_PERIBADI.STF_NO_KEKANANAN), HR_STAF_PERIBADI.STF_NO_KEKANANAN ASC
                        ";
...
//                                <td>' . $row->STF_EMAIL . '</td>                                
//                                <td>' . $row->STF_JWTN_ID . ', '.$row->STF_GRED_ID.', </td>
