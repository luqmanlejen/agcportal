...
<div class="form">
    ...
    if (isset($_GET['menu_id'])) {
        echo CHtml::hiddenField('OstArticles[menu_id]', $_GET['menu_id']);
    } else {
        ?>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                ...
                if (OstArticles::model()->chckdvsn() == 'n')
                    echo $form->dropdownlist($model, 'menu_id', OstMenuPortal::model()->getparent($menu_type), array('class' => 'col-sm-12'));
                if (OstArticles::model()->chckdvsn() == 'y')
                    echo $form->dropdownlist($model, 'menu_id', OstMenuPortal::model()->getparentfordvsn($menu_type), array('class' => 'col-sm-12'));
                ?>
    ...
    <div class="form-group">
        <div class="col-sm-2"><?php echo $form->labelEx($model, 'view_latest', array('class' => 'control-label')); ?></div>
        <div class="col-sm-10">
            <?php echo $form->dropdownlist($model, 'view_latest', array('1'=>'Yes','0'=>'No'), array('class' => 'col-sm-2')); ?>
            <?php echo $form->error($model, 'view_latest'); ?>
        </div>
    </div>
    <div class="space-4"></div>
    ...
    <div class="form-group">
        <div class="col-sm-2"><?php echo $form->labelEx($model, 'tag', array('class' => 'control-label')); ?></div>
        <div class="col-sm-10">
            <?php echo $form->textArea($model, 'tag', array('rows' => 6, 'class' => 'col-sm-12')); ?>
            <?php echo $form->error($model, 'tag');?>
            <span style='color:red'>semicolon</span>
        </div>
    </div>
    ...
    <div class="clearfix form-actions no-margin">
        <a href="index.php?r=ostArticles/admin<?php echo $exturl; ?>" class="btn btn-purple"><i class="ace-icon fa fa-arrow-left bigger-110s"></i>&nbsp;Back</a>&nbsp;&nbsp;
