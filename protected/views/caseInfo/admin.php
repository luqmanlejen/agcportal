                    ...
                    <div class="dataTables_wrapper form-inline no-footer" id="dynamic-table_wrapper">
                        ...
                        $this->widget('zii.widgets.grid.CGridView', array(
                            ...
                            'columns' => array(
                                ...
                                array('name' => 'case_month', 'value' => '$data->getDisplayRef($data->case_month)'),
                                array('name' => 'case_year', 'value' => '$data->getDisplayRef($data->case_year)'),
                                'hits',
                                ...
                                array('header' => 'Action', 'class' => 'CButtonColumn',
                                    ...
                                    array(
                                        'update' => array(
                                            ...
                                            'url' => 'Yii::app()->createUrl("caseInfo/update'.$exturl.'&id=".$data->id)',
                                            'imageUrl' => false,
                                        ),
                                        'delete' => array(
                                            ...
                                            'url' => 'Yii::app()->createUrl("caseInfo/delete'.$exturl.'&id=".$data->id)',
                                            //'visible' => '0'
                                        ),
                                    ),
                                ),
