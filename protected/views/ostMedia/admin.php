...
$('.search-form form').submit(function(){
	$('#ost-media-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
                                ...
                                array('header' => 'Action', 'class' => 'CButtonColumn',
                                    ...
                                    array(
                                        'archive' => array(
                                            ...
                                            'url' => 'Yii::app()->createUrl("ostMedia/archive&id=$data->id' . $exturl . '")',
                                            'imageUrl' => false,
                                        ...
                                        'unarchive' => array(
                                            ...
                                            'url' => 'Yii::app()->createUrl("ostMedia/unarchive&id=$data->id' . $exturl . '")',
                                            'imageUrl' => false,
                                        ...
                                        'update' => array(
                                            ...
                                            'url' => 'Yii::app()->createUrl("ostMedia/update' . $exturl . '&id=".$data->id)',
                                            'imageUrl' => false,
                                            'visible' => '1'
                                        ),
                                        'delete' => array(
                                            ...
                                            'imageUrl' => false,
                                            'url' => 'Yii::app()->createUrl("ostMedia/delete' . $exturl . '&id=".$data->id)',
                                            'visible' => '1'
                                        ),
                                    ),
                                ),
