...
<div class="form">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10" id="divroles">
            ...
            if (!$model->isNewRecord) {
                $rolesarr = $model->getroles2(2, $model->id);
                $rolesarr2 = $model->getroles2(3, $model->id);
            }
            ...
            echo CHtml::checkBoxList('role_code', $rolesarr, OstRefList::model()->listRef3(2)) . ':-<br><div style="padding-left:20px;">' . CHtml::checkBoxList('role_code2', $rolesarr2, OstRefList::model()->listRef3(3)) . '</div>';
            ?>
