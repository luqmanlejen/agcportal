    ...
    <header id="header" class="full_width clear">
        ...
        <div id="header-contact">
            ...
            <?php if (Yii::app()->session['lang'] == 'my') { ?>
                ...
                <a href='index.php?r=portal2/list&menu_id=MEFwUEVtZWVIcGdjb0c5Tkpadi8vZz09'><img src='images/awam.png' id='linkpublic'></a>
                <a href='index.php?r=portal2/list&menu_id=Z0RvUzVCbGZCNVVYY0VKMklJa08xQT09'><img src='images/bisnes.png' id='linkbusiness'></a>
                <a href='index.php?r=portal2/left&menu_id=djQ4NTR3NDNFSk5sTlJlR3c1clJXQT09'><img src='images/wargaAGC.png' id='linkstaff'></a>
            <?php } else { ?>
