                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="vid-thumb">
                                                                ...
                                                                <a class="popup-youtube" href="https://www.youtube.com/watch?v=TEnNaUg6Vm4">
                                                                    <div class="vid-box"><span class="ion-ios7-film"></span><img class="img-thumbnail" src="<?php echo Yii::app()->theme->baseUrl; ?>/images/lifestyle/lifestyle-slide-2.jpg" width="300" height="132" alt=""/> </div>
                                                                </a> </div>
                                                        </div>
                                                        <div class="col-sm-8">
                                                            <div class="sub-topic-thumb">
                                                                ...
                                                                <a href="#">
                                                                    <div class="sub-box"><img class="img-thumbnail" src="<?php echo Yii::app()->theme->baseUrl; ?>/images/lifestyle/lifestyle-slide-1.jpg" width="300" height="132" alt=""/> </div>
                                                                </a> </div>
                                                        </div>
                                                    </div>
                                                </div>
