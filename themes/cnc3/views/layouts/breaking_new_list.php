    ...
    <div class="row">
        <div class="col-sm-15"> <span class="ion-ios7-timer icon-news pull-left"></span>
            <ul id="js-news" class="js-hidden">
                <li class="news-item"><a href="#">FORMATION OF CONSTRUCTION CONTRACTS IN THE CONSTRUCTION INDUSTRY: THE PROCEDURES, TYPES AND PROBLEMS</a></li>
                <li class="news-item"><a href="#">PERINTAH GAJI MINIMUM 2012</a></li>
