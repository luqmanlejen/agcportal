        ...
        <div class="row">
            <div class="col-md-16 text-uppercase">
                <div class="row" >
                    ...
                    <div class="col-sm-5 col-md-2 wow fadeInUpLeft animated"><a class="navbar-brand" href="index.php?r=cnc/index">Chamber News Channels</a></div>
            
                    <div class="col-xs-11 col-sm-11" style="float:right">
                        <ul class="enlarge list-inline">
                            <li id="weather" style="margin-top:10px;"></li>
                            <li id="time-date" style="margin-top:10px"></li>
                            <li style="margin-top:10px">1246225 Hits</li>
