...
$user = OstUserRole::model()->findByAttributes(array('user_id' => Yii::app()->session['user_id']));
$role = $user->role_code;
                ...
                <div class="navbar-header pull-left">
                    ...
                    <a href="index.php?r=site/index" class="navbar-brand">
                        <small>
                            ...
                            <?php if($role == 'cnc_com' || $role == 'cnc_sec' || $role == 'cnc_sec'){ ?>
                                CNC's Official Portal (Administration)
                            <?php } else { ?>
                                AGC's Official Portal (Administration)
                            <?php } ?>
